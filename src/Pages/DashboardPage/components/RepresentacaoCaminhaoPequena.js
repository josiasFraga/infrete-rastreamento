...
export default function RepresentacaoCaminhaoPequena(props) {
  ...
  return (
    ...
    <img src={car_images[2]} width={52.5} style={{
      position: 'absolute', 
      top: 65, 
      left: 65, 
      transform: 'scaleX(-1)'
    }} />
    <img src={car_images[3]} width={50} style={{
      position: 'absolute', 
      top: 62, 
      left: 123,
      transform: 'rotate(6deg)'
    }} />
    <img src={car_images[4]} width={60} style={{
      position: 'absolute', 
      top: 60, 
      left: 180, 
    ...
    <img src={car_images[6]} width={56.5} style={{
      position: 'absolute', 
      top: 90, 
      left: 38,
    ...
    <img src={car_images[11]} width={55} style={{
      position: 'absolute', 
      top: 102, 
      left: 162, 
      transform: 'scaleX(-1)'
