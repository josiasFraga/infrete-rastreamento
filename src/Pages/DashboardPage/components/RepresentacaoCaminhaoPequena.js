...
export default function RepresentacaoCaminhaoPequena(props) {
  ...
  return (
    ...
    <div style={{ position: 'absolute', top: 67, left: 9 }}>
      <img src={car_images[1]} width={50} style={{ transform: 'rotate(5deg)', opacity: car_images[1] === 'car.png' || car_images[1] === "car_disabled.png" ? opacity_standard : 1 }} />
    ...
    <div style={{ position: 'absolute', top: 62, left: 123 }}>
      <img src={car_images[3]} width={50} style={{ transform: 'rotate(6deg)', opacity: car_images[3] === 'car.png' || car_images[3] === "car_disabled.png" ? opacity_standard : 1 }} />
    ...
    <div style={{ position: 'absolute', top: 60, left: 180 }}>
      <img src={car_images[4]} width={60} style={{ transform: 'scaleX(-1) rotate(2deg)', opacity: car_images[4] === 'car.png' || car_images[4] === "car_disabled.png" ? opacity_standard : 1 }} />
    ...
    <div style={{ position: 'absolute', top: 82, left: 178 }}>
      <img src={car_images[10]} width={55} style={{ transform: 'rotate(9deg)', opacity: car_images[10] === 'car.png' || car_images[10] === "car_disabled.png" ? opacity_standard : 1 }} />
