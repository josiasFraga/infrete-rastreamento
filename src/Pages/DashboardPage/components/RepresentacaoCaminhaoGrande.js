...
export default function RepresentacaoCaminhaoGrande(props) {
  ...
  return (
    ...
    <div style={{ position: 'absolute', top: 40, left: 25 }}>
      <img src={car_images[1]} width={100} style={{ transform: 'rotate(5deg)', opacity: car_images[1] === 'car.png' || car_images[1] === 'car_disabled.png' ? opacity_standard : 1 }} />
    ...
    <div style={{ position: 'absolute', top: 35, left: 249 }}>
      <img src={car_images[3]} width={100} style={{ transform: 'rotate(6deg)', opacity: car_images[3] === 'car.png' || car_images[3] === 'car_disabled.png' ? opacity_standard : 1 }} />
    ...
    <div style={{ position: 'absolute', top: 80, left: 220 }}>
      <img src={car_images[8]} width={110} style={{ transform: 'rotate(9deg)', opacity: car_images[8] === 'car.png' || car_images[8] === 'car_disabled.png' ? opacity_standard : 1 }} />
    ...
    <div style={{ position: 'absolute', top: 75, left: 355 }}>
      <img src={car_images[10]} width={110} style={{ transform: 'rotate(9deg)', opacity: car_images[10] === 'car.png' || car_images[10] === 'car_disabled.png' ? opacity_standard : 1 }} />
    ...
    <div style={{ position: 'absolute', top: 85, left: 470 }}>
      <img src={car_images[11]} width={120} style={{ transform: 'rotate(5deg)', opacity: car_images[11] === 'car.png' || car_images[11] === 'car_disabled.png' ? opacity_standard : 1 }} />
